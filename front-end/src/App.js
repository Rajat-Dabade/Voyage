    ...
    <>
      ...
      <Container maxWidth="lg" >
        {isSearching ? <p>Searching for the data</p> : isSearchData ?
          <ShowSearchData searchData={searchData} isLogin={isLogin} loginOpenHandler={loginOpenHandler} bookingHandler={bookingHandler}/> : isErrorInSearch ? <p>Error occur in search</p> : isSearchedOneTime ? <p>No result found</p> : <p>Please search search the data</p>}
      </Container>
      </> : <Booking /> }
    </>
  );
